...
export const CheckoutAndReviewBox: React.FC<{ artwork: ArtworkModel | undefined, mobile: boolean, isAuthenticated: any, isCheckedOut: boolean, checkoutArtwork: any }> = (props) => {
